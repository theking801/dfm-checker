      ...
      <div className="max-w-6xl mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-tech-600 to-purple-500 flex items-center justify-center text-white font-bold text-[10px] shadow-sm">
                DF
              </div>
              <span className="font-bold text-sm text-gray-800 dark:text-white">DFM Checker</span>
            </div>
        ...
        <div className="mt-10 pt-6 border-t border-gray-100 dark:border-gray-800/30 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[11px] text-gray-400 dark:text-gray-600">
            &copy; {new Date().getFullYear()} DFM Checker
          </p>
