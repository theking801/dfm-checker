  ...
  return (
    ...
    >
      <div
        ...
        style={(accentColor ? { '--sm-accent': accentColor } : {}) as React.CSSProperties}
      ...
      >
        ...
        >
          {(() => {
            const raw = colors && colors.length ? colors.slice(0, 4) : ['#1a1a2e', '#16213e'];
            let arr = [...raw];
            if (arr.length >= 3) {
        ...
        >
          <div className="sm-logo flex items-center select-none pointer-events-auto" aria-label="Logo">
            <span
              className="text-base font-normal tracking-tight text-gray-300"
          ...
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
              ...
              {items && items.length ? (
                items.map((it, idx) => (
                  <li className="sm-panel-itemWrap relative overflow-hidden leading-none" key={it.label + idx}>
                    <a
                      className="sm-panel-item relative text-white font-semibold text-[3.5rem] cursor-pointer leading-none tracking-[-2px] uppercase transition-colors duration-150 ease-linear inline-block no-underline pr-[1.4em] hover:text-tech-300"
                      href={it.link}
                      onClick={(e) => {
                        e.preventDefault();
                ...
                <li className="sm-panel-itemWrap relative overflow-hidden leading-none" aria-hidden="true">
                  <span className="sm-panel-item relative text-white font-semibold text-[3.5rem] cursor-pointer leading-none tracking-[-2px] uppercase inline-block no-underline pr-[1.4em]">
                    <span className="sm-panel-itemLabel inline-block [transform-origin:50%_100%] will-change-transform">
                      No items
                    </span>
                  </span>
            ...
            <div className="mt-8">
              <button
                ...
                className="text-sm font-semibold px-6 py-3 rounded-full bg-tech-600 text-white hover:bg-tech-700 transition-all duration-200 pointer-events-auto"
              >
                Analyser →
              </button>
            </div>
      ...
      <style>{`
        ...
        .sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; height: 100%; z-index: 10; }
        .sm-scope [data-position='left'] .staggered-menu-panel { right: auto; left: 0; }
        .sm-scope .sm-prelayers { position: absolute; top: 0; right: 0; bottom: 0; pointer-events: none; z-index: 5; }
